...
export default function Footer() {
    const scrollToTop = () => {
        ...
        const snapContainer = document.querySelector(
            ".explore-page-snap-container, .home-wrapper",
        );
        if (snapContainer) {
    ...
    return (
        <footer className="aesthetic-footer">
            <div className="footer-content">
                ...
                <div className="footer-brand">
                    ...
                    <p className="footer-mission">
                        Préserver et diffuser l'héritage vivant du Toit du Monde
                        à travers l'immersion numérique et l'analyse 3D.
                    </p>
                </div>
                ...
                <div className="footer-nav">
                    ...
                    <div className="footer-column">
                        ...
                        <Link to="/atlas" className="footer-link">
                            Atlas
                        </Link>
                        <Link to="/society" className="footer-link">
                            Society
                        </Link>
                        <Link to="/chronicles" className="footer-link">
                            Chronicles
                        </Link>
                    </div>
                    ...
                    <div className="footer-column">
                        ...
                        <Link to="/exploration" className="footer-link">
                            Exploration 3D
                        </Link>
                    ...
                    <div className="footer-column">
                        ...
                        <Link to="/sources" className="footer-link">
                            Bibliographie
                        </Link>
                        <Link to="/glossaire" className="footer-link">
                            Glossaire
                        </Link>
                    </div>
                    ...
                    <div className="footer-column">
                        ...
                        <a
                            href="https://github.com/edepmatss?tab=repositories"
                            target="_blank"
                        ...
                        <a
                            href="https://github.com/zoaavela?tab=repositories"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="footer-author"
                        >
                        ...
                        <a
                            href="https://github.com/goola971?tab=repositories"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="footer-author"
                        >
            ...
            <div className="footer-bottom">
                <p>
                    © {new Date().getFullYear()} — Mission d'Étude Tibet. Tous
                    droits réservés.
                </p>
